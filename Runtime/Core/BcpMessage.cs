...
namespace FutureBoxSystems.MpfMediaController
{
    public class BcpMessage
    {
        ...
        public string GetParamValue(string name, string typeHint = null)
        {
            ...
            {
                throw new ParameterException(name, this, ioe);
            }
        }
        ...
        public string ToString(bool encode)
        {
            ...
            {
                sb.Append(parameters[i].ToString(encode));
    ...
    public class BcpParameter
    {
        ...
        public string ToString(bool encode)
        {
            var name = encode ? Uri.EscapeDataString(Name) : Name;
            var value = encode ? Uri.EscapeDataString(Value) : Value;
